<?php
    ...
    class BookManager {
        ...
        public function insert(Book $book) {
            try {   
                $requete = $this->db->prepare('INSERT INTO book (title, description, nb_pages, nb_octets, asin, tome, language, url, mark, id_category, id_editor) VALUES(:title, :description, :nb_pages, :nb_octets, :asin, :tome, :language, :url, :mark, :id_category, :id_editor)');
                ...
                $requete->bindValue(':mark', $book->get_mark(), PDO::PARAM_INT);
