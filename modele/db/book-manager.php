<?php
    ...
    class BookManager {
        ...
        public function insert(Book $book) {
            try {   
                $requete = $this->db->prepare('INSERT INTO book (title, description, nb_pages, nb_octets, asin, tome, language, url, id_category, id_editor, id_author) VALUES(:title, :description, :nb_pages, :nb_octets, :asin, :tome, :language, :url,  :id_category, :id_editor, :id_author)');
        ...
        public function update(Book $book) {
            try {   
                $requete = $this->db->prepare('UPDATE book SET title = :title, description = :description, nb_pages = :nb_pages, nb_octets = :nb_octets, asin = :asin, tome = :tome, language = :language, url = :url, id_category = :id_category, id_editor = :id_editor, id_author = :id_author WHERE id_book = :id_book');
        ...
        public function get($id) {
            ...
            try {   
                $requete = $this->db->prepare('SELECT id_book, title, description, nb_pages, nb_octets, asin, tome, language, url, id_category, id_editor, id_author FROM book WHERE id_book = :id_book');
        ...
        public function get_all() {
            ...
            try {
                $requete = $this->db->query('SELECT id_book, title, description, nb_pages, nb_octets, asin, tome, language, url, id_category, id_editor, id_author FROM book');
        ...
        public function get_latest() {
            ...
            try {
                $requete = $this->db->query('SELECT id_book, title, description, nb_pages, nb_octets, asin, tome, language, url, id_category, id_editor, id_author FROM book ORDER BY id_book DESC LIMIT 10');
        ...
        public function get_book_by_id_category($id_category) {
            ...
            try {
                $requete = $this->db->prepare('SELECT id_book, title, description, nb_pages, nb_octets, asin, tome, language, url, id_category, id_editor, id_author FROM book WHERE id_category = :id_category');
