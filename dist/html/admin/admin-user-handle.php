<?php
    require '../../../controller/page/admin/admin-user-handle-controller.php';
?>
            ...
            <div class="users-container">
                ...
                <?php foreach($users as $user) : ?>
                    <div class="user-text-container">
                        ...
                        <a href="../../../controller/user/user-delete.php?id_user=<?= $user->get_id_user() ?>" class="material-symbols-outlined icon-delete">
                            delete
                        </a>
                    </div>
                <?php endforeach ?>
